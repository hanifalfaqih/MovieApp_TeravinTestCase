...
class ListMovieViewModel(private val repository: ListMovieRepository): BaseViewModelImpl(), ListMovieContract.ViewModel {

    private val listMovieResponseLiveData = MutableLiveData<Resource<List<Movie>>>()

    override fun getDiscoveryMoviesLiveData(): LiveData<Resource<List<Movie>>> = listMovieResponseLiveData
